...
import { Building2, CreditCard, MoreVertical, Pencil, ShieldAlert, ShieldCheck, Trash2, Users, ArrowRightLeft, KeySquare } from "lucide-react"
...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger, DialogDescription } from "@/app/shared/components/ui/dialog"
import {
	DropdownMenu,
	DropdownMenuContent,
	DropdownMenuItem,
							...
							<Table className="min-w-[800px] w-full">
								...
								<TableBody>
									{paginatedUsers.length === 0 ? (
										<TableRow>
											<TableCell colSpan={7} className="text-muted-foreground p-8 text-center">
												No users found
											</TableCell>
										</TableRow>
									) : (
										paginatedUsers.map(user => (
											<TableRow key={user.id} className="hover:bg-muted/50 transition-colors">
												...
												<TableCell className="text-muted-foreground h-16 leading-none">{user.email}</TableCell>
