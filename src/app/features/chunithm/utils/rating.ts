...
export const CHUNITHM_TIERS_OLD: readonly TierConfig[] = [
	{
		threshold: 17000,
		name: "Rainbow",
		textStyle: {
...
export const CHUNITHM_TIERS_NEW: readonly TierConfig[] = [
	{
		threshold: 17000,
		name: "Rainbow (極)",
		textStyle: {
...
export const getChunithmTiers = (version: number): readonly TierConfig[] => {
