...
export function useEquipNameplate() {
	...
	return useMutation({
		mutationFn: async (id: number) => {
			...
			const searchQueries = queryClient.getQueriesData<unknown>({ queryKey: ["userbox", "nameplate", "search"] })
		...
		onSuccess: (data, id) => {
			...
			queryClient.setQueriesData({ queryKey: ["userbox", "nameplate", "search"] }, old =>
