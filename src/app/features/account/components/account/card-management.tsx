...
export function CardManagement() {
	...
	return (
		<div className="space-y-4">
			...
			<Card className="rounded-md shadow-none">
				<CardHeader className="border-border px-4 py-3 sm:px-6">
					<CardTitle className="text-lg">Add Card</CardTitle>
				</CardHeader>
				<CardContent className="grid gap-6 p-4 sm:p-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
					<form
						className="space-y-3"
						onSubmit={event => {
					...
					>
						...
						<label htmlFor="account-eamuse-code" className="text-sm font-medium">
							e-amusement Code (E004, optional)
						</label>
						<Input
